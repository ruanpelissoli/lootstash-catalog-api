...
func FilterableStats() []StatCodeInfo {
	return []StatCodeInfo{
		...
		{Code: "res-pois-len", Name: "Poison Length Reduced", Description: "Poison Length Reduced By {value}%", Category: "Resistances", Aliases: []string{"pois-len"}, IsVariable: true},
		...
		{Code: "dmg-pois", Name: "Poison Damage Over Seconds", Description: "+{value} Poison Damage Over {param} Seconds", Category: "Damage", Aliases: []string{"pois-min", "pois-max"}, IsVariable: true, ParamLabel: "Seconds"},
		{Code: "dmg-mag", Name: "Adds Magic Damage", Description: "Adds {min}-{max} Magic Damage", Category: "Damage", Aliases: []string{"mag-min", "mag-max"}, IsVariable: true},
		...
		{Code: "ac%/lvl", Name: "Enh Defense/Lvl", Description: "+{value}% Enhanced Defense (Based On Character Level)", Category: "Per Level", IsVariable: true},
